...
function usage() {
  process.stdout.write(
    'Usage: npm run prepare:codex --prefix tooling/grove/probes -- [--output <outside-repo-directory>]\n' +
...
async function main(argv) {
  ...
  process.stdout.write(
    ...
    'First run the non-interactive validation:\n' +
    `  ${result.runCommand} --preflight\n\n` +
    'Then run this command from a separate interactive Terminal window:\n' +
    `  ${result.runCommand}\n\n` +
