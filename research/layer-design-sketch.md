...
(`view.js`). The interleaving mechanism: their skills call the CLI, the CLI
serves schema instructions — so our forked stanzas surface *through their
walkthrough automatically*. Fork discipline, resolved: **protocol vs craft**
