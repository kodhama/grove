...
A portable agent-swarm operating model for Claude Code — eleven chartered agent roles, a dispatch
...
It asks which agent roles to install (default: all eleven), copies their definitions into your
...
- **`skills/setup`** — `/grove:setup`: compose the eleven agent roles onto your project.
