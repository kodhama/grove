...
A portable agent-swarm operating model for Claude Code — twelve chartered agent roles, a dispatch
...
It asks which agent roles to install (default: all twelve), copies their definitions into your
...
- **`skills/setup`** — `/grove:setup`: compose the twelve agent roles onto your project.
...
- **`reference/agents/`** — the twelve agent definitions plus their `README.md`, vendored from this
