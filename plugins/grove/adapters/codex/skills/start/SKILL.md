...
This session runs Grove's dispatch rules without the deterministic stop guard; rule conformance here is prose-enforced only.

## Pointers

- Full dispatcher projection: ../../../../reference/charters/dispatcher.md
- Transition rules (data): ../../../../reference/dispatch/transitions.toml
- Guard CLI: ../../../../runtime/dispatch/bin/guard.mjs
- Run operations CLI: ../../../../runtime/dispatch/bin/grove-run.mjs
