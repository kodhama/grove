---
id: research-0038-spec-lifecycle-prior-art
type: research
status: draft
depends_on: []
owner: agent
...
Deep-research report, 2026-07-13. Stage-1 evidence annex for `adr-0038` (draft). This annex is
...
> its home — alongside the `adr-0038` draft, per the dependency-direction rule (grove cannot
