...
id: charter-context
type: charter
status: approved  # maintainer's intent act = the merge of this companion's landing PR (in-PR flip recording the act, adr-0007 precedent; lifecycle.md's own recorded practice); authored per approved adr-0050
depends_on: [adr-0050-read-model-and-context-budget, adr-0026-thin-vendor-boundary]
owner: agent
updated: 2026-08-03
---
